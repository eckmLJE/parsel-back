...
annotation1 = Annotation.create(user: users.sample, statement: disgraceful, start: 41, end: 116,        points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation2 = Annotation.create(user: users.sample, statement: disgraceful, start: 393, end: 448,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation3 = Annotation.create(user: users.sample, statement: disgraceful, start: 251, end: 315,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation4 = Annotation.create(user: users.sample, statement: rosensteinresponse, start: 20, end: 50,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation5 = Annotation.create(user: users.sample, statement: nochoice, start: 10, end: 30,            points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation8 = Annotation.create(user: users.sample, statement: nochoice, start: 100, end: 200,          points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation9 = Annotation.create(user: users.sample, statement: nochoice, start: 550, end: 600,          points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation6 = Annotation.create(user: users.sample, statement: sergeimagnitsky, start: 100, end: 150,   points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation7 = Annotation.create(user: users.sample, statement: sergeimagnitsky, start: 190, end: 210,   points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation10 = Annotation.create(user: users.sample, statement: backtowork, start: 20, end: 70,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation11 = Annotation.create(user: users.sample, statement: backtowork, start: 90, end: 120,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation12 = Annotation.create(user: users.sample, statement: backtowork, start: 150, end: 170,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation13 = Annotation.create(user: users.sample, statement: russianoil, start: 100, end: 200,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation14 = Annotation.create(user: users.sample, statement: russianoil, start: 800, end: 925,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation15 = Annotation.create(user: users.sample, statement: russianoil, start: 1500, end: 1600,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation16 = Annotation.create(user: users.sample, statement: democratsdemand, start: 5, end: 25,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation17 = Annotation.create(user: users.sample, statement: democratsdemand, start: 200, end: 295,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation18 = Annotation.create(user: users.sample, statement: democratsdemand, start: 500, end: 750,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)

annotation19 = Annotation.create(user: users.sample, statement: holdrussiaaccountable, start: 75, end: 275, points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation20= Annotation.create(user: users.sample, statement: holdrussiaaccountable, start: 700, end: 750, points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
