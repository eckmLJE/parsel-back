...
annotation14 = Annotation.create(user: users.sample, statement: russianoil, start: 275, end: 325,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation15 = Annotation.create(user: users.sample, statement: russianoil, start: 350, end: 500,       points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
...
annotation17 = Annotation.create(user: users.sample, statement: democratsdemand, start: 80, end: 150,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation18 = Annotation.create(user: users.sample, statement: democratsdemand, start: 135, end: 200,  points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation19 = Annotation.create(user: users.sample, statement: holdrussiaaccountable, start: 20, end: 70, points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
annotation20= Annotation.create(user: users.sample, statement: holdrussiaaccountable, start: 100, end: 200, points: Random.rand(-10..100), content: Faker::PrincessBride.quote)
